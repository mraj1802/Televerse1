# Getting Started with Televerse

Televerse is a play-and-earn web based NFT metaverse game with a full three.js built in. Through a variety of collecting and trading features, street battles, PvE, PvP, and syndicate events such as wars, Televerse aims to provide a source of amusement for both casual players and diehard DeFi aficionados.

Three factions in great turmoil, thrust into war over resources, grudges, and ideology in our Televerse.
...
```
git clone https://github.com/televerse03/Televerse.git
cd Televerse
npm install
npm run start
```
